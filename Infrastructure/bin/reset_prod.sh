...
oc expose dc/mlbparks-blue -l app=mlbparks -n ${GUID}-parks-prod --overwrite

oc delete svc/mlbparks-green -n ${GUID}-parks-prod
oc expose dc/mlbparks-green -l app=mlbparks,type=parksmap-backend -n ${GUID}-parks-prod --overwrite
...
oc expose dc/nationalparks-blue -l app=nationalparks -n ${GUID}-parks-prod --overwrite

oc delete svc/nationalparks-green -n ${GUID}-parks-prod
oc expose dc/nationalparks-green -l app=nationalparks,type=parksmap-backend -n ${GUID}-parks-prod --overwrite
